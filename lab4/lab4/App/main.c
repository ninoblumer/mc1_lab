                                  ...
                                  uint16_t buffer_length)
{
	...
	for(i=0;i<buffer_length;i++){
		result[0] += buffer[i*3] / buffer_length;
		result[1] += buffer[i*3+1] / buffer_length;
		result[2] += buffer[i*3+2] / buffer_length;
	}
//	result[0] = result[0] / buffer_length;
//	result[1] = result[1] / buffer_length;
//	result[2] = result[2] / buffer_length;
